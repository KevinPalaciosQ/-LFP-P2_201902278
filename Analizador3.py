...
# ======================estado==S1================================================
                ...
                if (letra.isalpha())  or ( letra=="_"):
                    ...
                    if (buffer == "Controles"):
                        ...
                        self.ListaTokens.append(Token("TIDENTIFICADOR",buffer,linea,columna))
                        buffer=""
                        columna+=1
                        estado="S0"
# ===========================ESTADO=S2=================================================
...
# ===========================ESTADO=S3=================================================
                ...
                if letra =="/":
                    ...
                    buffer+=letra
                    columna +=1
                    self.ListaErrores.append(Error(letra, "no reconocido", linea, columna))
                    buffer= ""
                    estado ="S0"
            elif estado == "S4":
                if letra =="\n":
                    self.ListaTokens.append(Token("Comentario Simple",buffer,linea,columna))
                    columna=1
                    linea+=1
                    buffer=""
                    contador -=1
                ...
                if letra =="*":
                    buffer+=letra
                    columna+=1
                    if textozz[contador+1]=="/":
                        buffer+=textozz[contador+1]
                        columna+=1
                        self.ListaTokens.append(Token("Comentario Multilinea",buffer,linea,columna))
                        buffer=""
                        estado="S0"
                        contador+=1
                    else:
                ...
                if letra =='"':
                    buffer+=letra
                    self.ListaTokens.append(Token("Cadena",buffer,linea,columna))
                    columna+=1
                    buffer=""
                    estado ="S0"
                else:
